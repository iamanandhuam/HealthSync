...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const SmartWatchDashboard(),
...
class SmartWatchDashboard extends StatefulWidget {
  //const SmartWatchDashboard({Key? key}) : super(key: key);
...
class SmartWatchDashboardState extends State<SmartWatchDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Smartwatch Health Monitor'),
        actions: [
          Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: isConnected ? toggleDataGeneration : null,
                ...
                ElevatedButton(
                  onPressed: isConnected ? getSingleReading : null,
                  style: ElevatedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 24, vertical: 12),
                  ),
